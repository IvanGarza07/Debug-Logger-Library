package com.igarza.debugloggercore.data.logger
...
class DebugLogger(
    ...
    companion object {
        ...
        fun install(context: Context, config: LoggerConfig = LoggerConfig()) {
            ...
            instance = LoggerInstance.getDebugLogger(context)
        }
        ...
        fun getInstance(): DebugLogger {
            return instance ?: LoggerInstance.getDebugLogger(
                LoggerInstance.getContext()
            ).also { instance = it }
        }
